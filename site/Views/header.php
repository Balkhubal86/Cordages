        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse bg-white rounded " id="navbarNav">
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-primary don rounded" onclick="window.open('https://www.helloasso.com/associations/les-ateliers-cord-ages/formulaires/2', '_blank')">Faire un Don</button>
                    <a href="index.php?view=member&action=display"><button type="button" class="btn btn-secondary membre rounded" >Devenir Adhérent</button></a>
                    <a href="index.php?view=volunteer&action=display"><button type="button" class="btn btn-success benevole rounded">Devenir Bénévole</button></a>
                    <a href="index.php?view=sponsor&action=display"><button type="button" class="btn btn-danger mecene rounded">Devenir Mécène</button></a>
                </div>
                <br>
            </div>
        </div>
